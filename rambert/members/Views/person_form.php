<div class="person row bg-light border-bottom border-primary pt-2 pb-2 mb-4">
    <!-- If new person display "new person" title, else display the name of the person to update -->
    <?php if ($person['id'] == 0): ?>
        <div class="col-12 mb-2">
            <span class="text-primary"><strong><?= lang('members_lang.title_new_person') ?></strong></span>
        </div>
    <?php else: ?>
        <div class="col-12 mb-2">
    ...
    <?= form_open('person/save/'.($person['id'] ?? 0), ['class' => 'col-12', 'id' => 'person_form']) ?>
        ...
        <input type="hidden" id="fk_home" name="fk_home" value="<?= $home['id'] ?>" />
                    ...
                    <div class="col-sm-8">
                        <select id="fk_category" name="fk_category" class="custom-select custom-select-sm">
                            <?php foreach ($categories as $category): ?>
                                <?php $selected = ''; ?>
                                <?php if (!empty($person['fk_category']) && $person['fk_category'] == $category['id']): ?>
                                    <?php $selected = 'selected'; ?>
                                <?php endif; ?>
